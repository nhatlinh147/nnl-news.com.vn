                              ...
                              <li>
                                 <div class="media wow fadeInDown"> <a class="media-left" href="<?php echo $link ?>"><img src="<?php echo $image_name; ?>" alt=""></a>
                                    <div class="media-body">
                                       <h4 class="media-heading"><a href="<?php echo $link ?>"><?php echo $product['Product_Name'] ?>
                                          </a></h4>
                        ...
                        <div class="col-md-6" style="<?php echo $check % 2 != 0 ? 'float:none;' : '' ?> padding-right:0px">
                           ...
                           <div class="single_category">
                              ...
                              <ul class="fashion_catgnav wow fadeInDown">
                                 <li>
                                    <div class="catgimg2_container"> <a href="<?php echo $link  ?>"><img alt="" src="<?php echo $image_name ?>"></a> </div>
                                    <h2 class="catg_titile"><a href="<?php echo $link  ?>"><?php echo $product['Product_Name']  ?></a>
                                    </h2>
                                    <div class="comments_box"> <span class="meta_date"><?php echo $product['created_at']  ?></span> <span class="meta_comment"><a href="#">No Comments</a></span> <span class="meta_more"><a href="#">Read More...</a></span> </div>
                                    <p><?php echo General::limitContent($product['Meta_Desc_Product'], 20)  ?></p>
                                 </li>
                              </ul>
