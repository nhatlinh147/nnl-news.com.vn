    ...
    <div class="reg-w3">
        <div class="w3layouts-main">
            ...
            <form action="<?php echo General::view_link('dang-ky.html'); ?>" method="post" id="Form_Registy">
                ...
                <h4 style="margin-top: 1rem;"><input type="checkbox" name="agree_policy" class="agree_policy" />Tôi đồng ý chính sách và điều khoản của công ty</h4>
                <div class="clearfix"></div>
                <input type="submit" value="submit" name="register">
            </form>
            <p>Nếu bạn đã có tài khoản . Xin hãy<a href="<?php echo General::view_link('dang-nhap.html'); ?>">đăng nhập</a></p>
        </div>
    </div>
