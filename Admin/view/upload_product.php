...
$upload_dir["img"] =  $_GET['admin'] ? 'Admin/ckeditor' : "view/ckeditor-user";
// 'D:/xampp/htdocs/Projec PHP thuần/Admin/ckeditor'
// 'D:/xampp/htdocs/Projec PHP thuần/view/ckeditor_user'
...
if (isset($_FILES['upload']) && strlen($_FILES['upload']['name']) > 1) {
    ...
    if ($re == '') {
        if (move_uploaded_file($_FILES['upload']['tmp_name'], $uploadpath)) {
            ...
            //Url đến địa chỉ ảnh hiển thị
            $image_name = pathinfo($f_name)['filename'];
            $url = $_GET['admin'] ? Path::path_file("Ckeditor_$image_name") : Path::path_file("Ckeditor-user_$image_name");
